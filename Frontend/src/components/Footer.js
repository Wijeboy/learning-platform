      ...
      <div className="footer-container">
        <div className="footer-section">
          <div className="footer-logo">
            ...
            <span className="footer-logo-text">LearnX</span>
          </div>
          <p className="footer-description">
            Empowering your tomorrow, shape your journey with the skills of tomorrow. From your journey with our expert mentors today.
          </p>
        ...
        <div className="footer-section">
          ...
          <ul className="footer-contact">
            <li>
              ...
              <span>info@learnx.com</span>
            </li>
            <li>
              <span className="contact-icon">📞</span>
              <span>+11 2345789</span>
            </li>
            <li>
              <span className="contact-icon">📍</span>
